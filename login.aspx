    ...
    <form id="form2" runat="server">
        <div class="popup">
            <div class="form">
                ...
                <div class="element">
                    <asp:Label ID="L1" runat="server" Text="Username"></asp:Label><span style="color:red;"> * </span>
                    <asp:TextBox ID="Umail" runat="server" CssClass="form-control" placeholder="Enter username"></asp:TextBox>
                </div>
                <div class="element">
                    <asp:Label ID="L2" runat="server" Text="Password"></asp:Label><span style="color:red;"> * </span>
